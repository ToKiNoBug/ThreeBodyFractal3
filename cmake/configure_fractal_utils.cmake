...
if(NOT EXISTS ${CMAKE_SOURCE_DIR}/3rdParty/FractalUtils/.git)
    ...
    execute_process(COMMAND git clone "https://github.com/ToKiNoBug/FractalUtils.git"
...
execute_process(COMMAND cmake --build . --parallel
    WORKING_DIRECTORY ${fu_build_dir}
    COMMAND_ERROR_IS_FATAL ANY OUTPUT_VARIABLE output_temp)
...
if(NOT ${fractal_utils_FOUND})
    ...
    message(FATAL_ERROR "Unprecedented error : fractal_utils installed but find_package failed to find it. Adding its installation dir failed to fix this problem.")
endif()

unset(CFP_temp)

message("fractal_utils_INCLUDE_DIR = " ${fractal_utils_INCLUDE_DIR})
message("FractalUtils installed and is avaliable by find_package. CMAKE_PREFIX_PATH = " ${CMAKE_PREFIX_PATH})